...
*** Keywords ***
Collect Excel File Link From User
    Add heading    Enter Excel File Link
    Add text input    link
    ${response}=    Run dialog
...
*** Keywords ***
Get orders
    ${excel_file_download_link}=    Collect Excel File Link From User
    Download    ${excel_file_download_link}    overwrite=True
